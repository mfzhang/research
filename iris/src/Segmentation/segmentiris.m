...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Parameters specific for CASIA v1 DATABASE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lpupilradius = 28; %lower bound for pupil radius
upupilradius = 75; %upper bound for pupil radius
lirisradius = 80;  %lower bound for iris radius
uirisradius = 150; %upper bound for iris radius
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Finding the iris boundary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Modified - add the parameter type, wich indicates if it's processing iris
%or pupil region
%findcircle(image, lradius, uradius, scaling, sigma, hithres, lowthres, vert, horz, type)

%modificado - adicionado o ultimo parametro (1 para iris, 2 para pupila)
%em vert, usasse 1 e horz 0, pois estamos indo calcular a
%borda da iris, onde os "edges" verticais são mais expressivos que os horizontais
[row, col, r] = findcircle(eyeimage, lirisradius, uirisradius, scaling, 2, 0.20, 0.19, 1.00, 0.00, 1);
...
%find pupil boundary
%modificado - adicionado o ultimo parametro (1 para iris, 2 para pupila)
[rowp, colp, r] = findcircle(imagepupil, lpupilradius, upupilradius, 0.6, 2, 0.25, 0.25, 1.00, 1.00, 2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Finding BOTTOM EYELID occlusion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%find bottom eyelid
...
% Finding EYELASHES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%For CASIA v1 database, eliminate eyelashes by thresholding
ref = eyeimage < 100;
coords = find(ref==1);
