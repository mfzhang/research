...
% November 2008 - Comments in Portuguese added, Carlos Bastos
...
function h = addcircle(h, c, radius, weight)
    ...
    %ok. relacao entre x e y em um círculo. theta é o angulo entre os
    %segmentos x e y (projecoes).
    ...
    ind = px+(py-1)*hr;
    %Aqui acumula no espaço de hough
    h(ind) = h(ind) + weight;